...
let options: Object = {
    ...
    workerController: workerControllerPath || path.join(__dirname, './services/worker.js'),
    brokerController: brokerControllerPath || path.join(__dirname, './services/broker.js'),
...
// let SOCKETCLUSTER_OPTIONS: Object;
...
let startWhenFileIsReady = (filePath: PathLike) => {
